...
# Barantem Dlu kita
#Klo Mau Ricode Cht gua 088294084614
H = '\x1b[1;32m'
K = '\x1b[1;33m'
U = '\x1b[1;34m'
P = '\x1b[1;35m'
...
try:
    ...
    def Banner():
        Tik('' + C + '\n\x1b[1;97m\n    /\\_/\\           ___\n   = o_o =_______    \\ \\  -Subscribe TUTORIAL ANDROID-\n    __^      __(  \\.__) )\n(@)<_____>__(_____)____/\n==================================================\nYoutube \x1b[1;91m:\x1b[1;96mTUTORIAL ANDROID\x1b[1;97m\nGithub  \x1b[1;91m:\x1b[1;92mhttps://github.com/Mr-S4NTUY\x1b[1;97m\ncontoh nomor yang salah \x1b[1;91m:\x1b[1;96m8729xxxxxxx\x1b[1;97m\ncontoh nomor yang benar \x1b[1;91m:\x1b[1;96m08729xxxxx\x1b[1;97m\n  ' + W + 'Creator : Mr-S4NTUY\n\t\tYT : TUTORIAL ANDROID')
    ...
    def MapClub(Phone, Amount):
        for _ in range(Amount):
            ...
            if 'error' in postData.text:
                print W + '[' + C + '*' + W + '] LAGI SPAM YA SAYANG KE No ' + C + str(Phone) + W + ' STATUS GAGAL WKWKWK' + M + ' \xe2\x9c\x96'
            else:
                print W + '[' + C + '*' + W + '] LAGI SPAM YA SAYANG KE NO ' + C + str(Phone) + W + ' STATUS BERHASIL' + H + ' \xe2\x9c\x94'
    ...
    def Hooq(Phone, Amount):
        for _ in range(Amount):
            ...
            if 'Your+number+has+been+blocked.' in submit.geturl():
                ...
                print W + '[' + C + '*' + W + '] LAGI SPAM YA SAYANG KE NO ' + C + str(Phone) + W + ' STATUS GAGAL' + M + ' \xe2\x9c\x96'
    ...
    def HarVest(Phone, Amount):
        for _ in range(Amount):
            ...
            if 'Enter OTP code we sent via SMS on phone number' in postData.text:
                print W + '[' + C + '*' + W + '] LAGI SPAM YA SAYANG KE NO ' + C + str(Phone) + W + ' BERHASIL' + H + ' \xe2\x9c\x94'
                Sess.cookies.save()
            else:
                print W + '[' + C + '*' + W + '] LAGI SPAM YA SAYANG KE NO ' + C + str(Phone) + W + ' GAGAL WKWKWKWKWK' + M + ' \xe2\x9c\x96'
    ...
    def Tokped(Phone, Amount):
        for _ in range(Amount):
            ...
            headers = {'Connection': 'keep-alive', 
               ...
               'X-Requested-With': 'XMLHttpRequest', 'User-Agent': 'Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; rv:11.0) like Gecko', 
            ...
            if '"success": true' in postData.text:
                ...
                print W + '[' + C + '*' + W + '] LAGI SPAM YA SAYANG KE NO ' + C + str(Phone) + W + ' [STATUS] GAGAL -_-' + M + ' \xe2\x9c\x96'
    ...
    def Spam():
        ...
        if PilihTools == '1':
            ...
            print
            print W + 'JANGAN LUPA SUBREK GW: TUTORIAL ANDROID' + C + ' -_-x'
            sys.exit()
        else:
            print
